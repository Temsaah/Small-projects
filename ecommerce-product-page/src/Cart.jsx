...
function Cart() {
  ...
  return (
    <div className="animation-slide-in absolute right-2 top-20 z-30 flex min-h-64 w-[95%] max-w-[400px] -translate-x-1/2 flex-col rounded-xl bg-white shadow-xl sm:right-0 md:top-24 2xl:!translate-x-1/3">
